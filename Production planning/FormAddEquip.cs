...
namespace Production_planning
{
    public partial class FormAddEquip : MaterialForm
    {
        ...
        public FormAddEquip(ScheduleTemplateModel workAreas = null)
        {
            InitializeComponent();

            _edit = workAreas != null;
        ...
        private async Task LoadTemplate()
        {
            ...
            else
            {
                ...
                textBoxEquipName.Text = _scheduleTemplate.Name;
                textBoxDate.Text = _scheduleTemplate.BaseDate.ToString("dd.MM.yyyy");
                comboBoxTemplates.SelectedIndex = id;*/
            }
        }
        ...
        private async Task SaveTemplate()
        {
            ...
            newTemplate.Name = textBoxEquipName.Text;
            newTemplate.CycleId = _scheduleCycles[comboBoxTemplates.SelectedIndex].Id;
